            ...
            <table class="table table-hover table-striped table-bordered text-center align-middle">
                ...
                <tbody class="table-group-divider">
                    ...
                    <tr>
                        ...
                        <td>{{$user->email}}</td>
                        <td>
                            <img src="{{ asset('https://pd-unpad.site/storage/' . $user->image) }}" alt="Foto {{$user->name}}" width="100vh" class="img-thumbnail rounded zoom">
                        </td>
                        <td>
                            <img src="{{ asset('https://pd-unpad.site/storage/' . $user->ktm) }}" alt="KTM {{$user->name}}" width="200vh" class="img-thumbnail zoom">
                        </td>
                        @if($user->is_active == 1)
                            <td>Verified</td>
                            @else
                ...
                @foreach($datas as $data)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <img src="{{ asset('https://pd-unpad.site/storage/' . $data->image) }}" width="100" height="auto" class="img-thumbnail border-0 rounded-start zoom" alt="Header {{$data->nama}}">
                            @endif
                        </td>
                        <td>{{$data->kategori}}</td>
                        <td>{{$data->sumber}}</td>
